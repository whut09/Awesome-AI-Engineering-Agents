...
Use a concise title such as `Add <project> to FPGA engineering`. In the pull
request body, state why the resource fits the selected role and identify its
paper venue or repository license. Keep unrelated formatting changes out of the
same pull request.
